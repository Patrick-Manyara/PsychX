<?php
$page = 'applied_therapists';
require_once '../path.php';
include_once 'header.php';
$therapists = get_all_therapists('deactivated');
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <a href="../model/approve?id=<?= $therapist_id ?>&table=<?= encrypt('therapist') ?>&page=<?= encrypt('view_therapists') ?>" class="btn btn-info">
                                    Approve
                                </a>
                            </td>
                        </tr>
