                    ...
                    <div class="flex-grow-1 mt-3 mt-sm-5">
                        <div class="d-flex align-items-md-end align-items-sm-start align-items-center justify-content-md-between justify-content-start mx-4 flex-md-row flex-column gap-4">
                            <div class="user-profile-info">
                                <h4><?= $profile['therapist_name'] ?></h4>
                                <ul class="list-inline mb-0 d-flex align-items-center flex-wrap justify-content-sm-start justify-content-center gap-2">

                                    <li class="list-inline-item fw-semibold"><i class="bx bx-map"></i> <?= $profile['therapist_address'] ?></li>
                                    <li class="list-inline-item fw-semibold">
                                        <i class="bx bx-calendar-alt"></i> Joined <?= get_month_name($profile['therapist_date_created']) . ' ' . get_full_year($profile['therapist_date_created']) ?>
                                    </li>
                                </ul>
                            </div>
                ...
                <div class="card-body">
                    ...
                    <ul class="list-unstyled mb-4 mt-3">
                        <li class="d-flex align-items-center mb-3">
                            ...
                            <span><?= $profile['therapist_name'] ?></span>
                        </li>
                        <li class="d-flex align-items-center mb-3">
                            <i class="bx bx-check"></i><span class="fw-semibold mx-2">Status:</span> <span>Active</span>
                        </li>
                        <li class="d-flex align-items-center mb-3">
                            <i class="bx bx-star"></i><span class="fw-semibold mx-2">Gender:</span> <span><?= $profile['therapist_gender'] ?></span>
                        </li>
                        <li class="d-flex align-items-center mb-3">
                            <i class="bx bx-flag"></i><span class="fw-semibold mx-2">Location:</span> <span><?= $profile['therapist_location'] ?></span>
                        </li>
                    ...
                    <ul class="list-unstyled mb-4 mt-3">
                        <li class="d-flex align-items-center mb-3">
                            ...
                            <span><?= $profile['therapist_phone'] ?></span>
                        </li>
                        <li class="d-flex align-items-center mb-3">
                            <i class="bx bx-chat"></i><span class="fw-semibold mx-2">Message:</span> <span><?= $profile['therapist_phone'] ?></span>
                        </li>
                        <li class="d-flex align-items-center mb-3">
                            <i class="bx bx-envelope"></i><span class="fw-semibold mx-2">Email:</span>
                            <span><?= $profile['therapist_email'] ?></span>
                        </li>
                    </ul>
