...
$session_today  = get_session_today($_SESSION['corporate_id']);
$past_sessions  = get_past_sessions($_SESSION['corporate_id']);
$next_sessions  = get_upcoming_sessions($_SESSION['corporate_id']);
?>
        ...
        <div class="col-lg-12 mb-4 order-0">
            <div class="card">
                <div class="d-flex align-items-end row">
                    <div class="col-sm-7">
                        <div class="card-body">
                            <h5 class="card-title text-primary">Welcome <?= $_SESSION['corporate_name'] ?>! 🎉</h5>
                            <p class="mb-4">
                                <?php
